    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_subordinate_one', models.ImageField(blank=True, upload_to='products/')),
                ('image_subordinate_two', models.ImageField(blank=True, upload_to='products/')),
                ('image_subordinate_three', models.ImageField(blank=True, upload_to='products/')),
                ('image_subordinate_four', models.ImageField(blank=True, upload_to='products/')),
